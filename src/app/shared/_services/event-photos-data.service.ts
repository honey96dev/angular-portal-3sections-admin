...
export class EventPhotosDataService {
  ...
  add(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.eventPhotos.add}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  edit(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.eventPhotos.edit}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  delete(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.eventPhotos.delete}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  get(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.eventPhotos.get}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
