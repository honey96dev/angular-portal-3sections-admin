...
export class OurClientsDataService {
  ...
  add(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourClients.add}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  edit(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourClients.edit}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  delete(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourClients.delete}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
