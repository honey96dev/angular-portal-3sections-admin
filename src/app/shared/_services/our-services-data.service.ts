...
export class OurServicesDataService {
  ...
  add(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourServices.add}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  edit(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourServices.edit}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
  ...
  delete(params) {
    return this.http.post<any>(`${environment.apiUrl}${apis.common.ourServices.delete}`, params)
      .pipe(map(res => {
        return res;
      }));
  }
