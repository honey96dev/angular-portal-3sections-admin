...
@Component({
  selector: 'app-shared-our-services-data',
  templateUrl: './shared-our-services-data.component.html',
  styleUrls: ['./shared-our-services-data.component.scss']
})
export class SharedOurServicesDataComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addUrl = sprintf("/%s/%s", this.category, routes._partials.ourServices.edit);
    this.editUrl = sprintf("/%s/%s", this.category, routes._partials.ourServices.edit);
    this.loadData();
  }
