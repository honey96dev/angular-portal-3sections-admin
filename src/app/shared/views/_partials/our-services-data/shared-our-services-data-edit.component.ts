...
@Component({
  selector: 'app-shared-our-services-data-edit',
  templateUrl: './shared-our-services-data-edit.component.html',
  styleUrls: ['./shared-our-services-data-edit.component.scss']
})
export class SharedOurServicesDataEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.backUrl = sprintf("/%s/%s", this.category, routes._partials.ourServices.main);
    this.config = {
      url: `${environment.apiUrl}${apis.common.upload}/our-services`,
