...
@Component({
  selector: 'app-shared-prev-sponsor-data',
  templateUrl: './shared-prev-sponsor-data.component.html',
  styleUrls: ['./shared-prev-sponsor-data.component.scss']
})
export class SharedPrevSponsorDataComponent implements OnInit {
  ...
  headElements = [
    '',
    this.translate.instant('SHARED_PREV_SPONSORS.NAME'),
    this.translate.instant('SHARED_PREV_SPONSORS.TIMESTAMP'),
    this.translate.instant('SHARED_PREV_SPONSORS.SPONSOR'),
    this.translate.instant('SHARED_PREV_SPONSORS.DESCRIPTION'),
    this.translate.instant('SHARED_PREV_SPONSORS.LOGO'),
  ];
  ...
  ngOnInit() {
    ...
    this.addUrl = sprintf("/%s/%s", this.category, routes._partials.prevSponsors.edit);
    this.editUrl = sprintf("/%s/%s", this.category, routes._partials.prevSponsors.edit);
    this.loadData();
  }
