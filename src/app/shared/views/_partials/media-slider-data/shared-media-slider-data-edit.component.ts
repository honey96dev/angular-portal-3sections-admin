...
@Component({
  ...
  templateUrl: './shared-media-slider-data-edit.component.html',
  styleUrls: ['./shared-media-slider-data-edit.component.scss']
})
export class SharedMediaSliderDataEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.backUrl = sprintf("/%s/%s", this.category, routes._partials.mediaSlider.main);
    this.config = {
